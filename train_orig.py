...
def config():
    ...
    Config['cnn_form'] = True
    Config['input_dim'] = 1000 # 1000 if cnn_form else 79800
    Config['alpha'] = 0.
...
def experiment(Config):
    ...
    train_dataset = HCPOrigDataset(Config['data_root'], Config['task_id'], mode='train')
    val_dataset = HCPOrigDataset(Config['data_root'], Config['task_id'], mode='test')
